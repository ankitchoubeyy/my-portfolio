...
function AchivementsSection() {
  return (
    <div className="py-8 xl:gap-16 sm:py-16 xl:px-16 flex items-center justify-center">
      <div className="sm:border-[#3335f] sm:border rounded-md py-8 px-16 flex flex-row items-center justify-between">
